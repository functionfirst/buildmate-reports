Partial Class AdhocCosts
    ...
    ";database=getbuild_mate"
        ...
        Me.SqlDataSource1.SelectCommand = "dbo.report_ADHOC_COSTS"
        ...
        Me.reportNameTextBox.Value = "Ad-hoc Cost (Break-down)"
        '
        'pageFooter
        '
        ...
        Me.detail.Items.AddRange(New Telerik.Reporting.ReportItemBase() {Me.resourceNameDataTextBox, Me.TextBox2})
        ...
        Me.resourceNameDataTextBox.Value = "=Fields.description"
        '
        'TextBox2
        '
        ...
        Me.resourceNameCaptionTextBox.Location = New Telerik.Reporting.Drawing.PointU(Telerik.Reporting.Drawing.Unit.Cm(0R), Telerik.Reporting.Drawing.Unit.Cm(-0.000000050465263967680585R))
        ...
        Me.resourceNameCaptionTextBox.Value = "Description" & Global.Microsoft.VisualBasic.ChrW(9)
        '
        'labelsGroupHeader
        '
        Me.labelsGroupHeader.Height = Telerik.Reporting.Drawing.Unit.Cm(0.70999991893768311R)
        Me.labelsGroupHeader.Items.AddRange(New Telerik.Reporting.ReportItemBase() {Me.resourceNameCaptionTextBox, Me.TextBox1})
        ...
        Me.priceSumFunctionTextBox.Value = "=Sum(Fields.total" & Global.Microsoft.VisualBasic.ChrW(9) & ")"
        '
        ...
        Me.TextBox6.Value = "Ad-hoc Items"
        '
