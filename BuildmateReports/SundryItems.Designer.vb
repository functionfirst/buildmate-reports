Partial Class SundryItems
    ...
    ";database=getbuild_mate"
        ...
        Me.SqlDataSource1.SelectCommand = "dbo.report_SUNDRY_ITEMS"
        ...
        Me.reportNameTextBox.Value = "Sundry Cost (Break-down)"
        '
        'pageFooter
        '
        ...
        Me.resourceNameDataTextBox.Value = "=Fields.buildElementName"
        '
        'TextBox2
        '
        ...
        Me.TextBox2.Value = "=Fields.spaceprice"
        '
        'labelsGroup
        '
        ...
        Me.resourceNameCaptionTextBox.Value = "Element Name"
        '
        'TextBox1
        '
        ...
        Me.priceSumFunctionTextBox.Value = "=Sum(Fields.spaceprice)"
        '
        'TextBox3
        '
        ...
        Me.TextBox6.Value = "Sundry Items"
        '
        'TextBox4
        '
        ...
        Me.TextBox4.Value = "Element Type"
        '
        'TextBox5
        '
        ...
        Me.TextBox5.Value = "=Fields.buildElementType"
        '
        'TextBox8
        '
